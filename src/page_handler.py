...
class PageHandler:
    def __init__(s, osi, mode, page_size):
        ...
        s.prev_button = BasicButton(s.mainframe, font=FONT_M, text="PREVIOUS", width=10, command=s.prev)
        s.prev_button.pack(side=LEFT)

        s.next_button = BasicButton(s.mainframe, font=FONT_M, text="NEXT", width=10, command=s.next)
